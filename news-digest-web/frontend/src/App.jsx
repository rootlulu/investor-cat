...
function StocksPage({ stockId = "" }) {
  ...
  return (
    ...
    >
      <nav className="section-jump-nav" aria-label="股票页面分区">
        <a href="#stock-market">市场概览</a>
        <a href="#stock-watchlist">自选个股</a>
        <a href="#stock-industry">行业融资</a>
      </nav>
      ...
      <div id="stock-watchlist" className="dashboard-section-anchor">
        <WatchlistTable
          items={watchlist}
